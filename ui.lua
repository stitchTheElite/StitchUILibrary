...
function library:CreateWindow(name)
    ...
    UICorner.CornerRadius.Scale = UDim.new(0)
    UICorner.CornerRadius.Offset = UDim.new(6)
    UICorner2.Parent = TextButton
    UICorner2.CornerRadius.Scale = UDim.new(0)
    UICorner2.CornerRadius.Offset = UDim.new(6)
